...
export interface PublicSdkClient {
    ...
    dataSources: {
        ...
        instances: {
            list(input?: Partial<ListDataSourceInstancesInput>): Promise<ListDataSourceInstancesOutput>;
            get(input: GetDataSourceInstanceInput): Promise<GetDataSourceInstanceOutput>;
            create(input: Omit<CreateDataSourceInstanceInput, "projectId"> & Partial<Pick<CreateDataSourceInstanceInput, "projectId">>): Promise<CreateDataSourceInstanceOutput>;
            update(input: UpdateDataSourceInstanceInput): Promise<UpdateDataSourceInstanceOutput>;
            delete(input: DeleteDataSourceInstanceInput): Promise<DeleteDataSourceInstanceOutput>;
        };
        streams: {
            ...
            update(input: UpdateDataSourceStreamInput): Promise<UpdateDataSourceStreamOutput>;
