...
/**
 * Input and output of every contract operation, for the few whose contract
 * module exports no named `<Operation>Input` / `<Operation>Output` type
 * (`logSources.verify`, `sandboxClis.verify`, the external-identity JIT
 * policies, Microsoft Teams admin consent).
 */
type ContractInputs = InferContractRouterInputs<PublicApiContract>;
type ContractOutputs = InferContractRouterOutputs<PublicApiContract>;
...
export interface PublicSdkClient {
    ...
    automations: {
        ...
        delete(input: DeleteAutomationInput): Promise<DeleteAutomationOutput>;
        runs: {
    ...
    /**
     * Project dashboards authored as MDX. `projectId` defaults to the
     * credential's project. create/update return the `editBase` to insert into
     * `DashboardMeta` before the next update.
     */
    dashboards: {
        list(input?: Partial<ListDashboardsInput>): Promise<ListDashboardsOutput>;
        get(input: Pick<GetDashboardInput, "id"> & Partial<Omit<GetDashboardInput, "id">>): Promise<GetDashboardOutput>;
        validate(input: ValidateDashboardInput): Promise<ValidateDashboardOutput>;
        create(input: CreateDashboardInput): Promise<DashboardWriteOutput>;
        update(input: UpdateDashboardInput): Promise<DashboardWriteOutput>;
        render(input: RenderDashboardInput): Promise<RenderDashboardOutput>;
        delete(input: DeleteDashboardInput): Promise<DeleteDashboardOutput>;
    };
    logs: {
    ...
    onboarding: {
        ...
        skipIntegration(input: SkipOnboardingIntegrationInput): Promise<SkipOnboardingIntegrationOutput>;
        skipGithubAppInstallation(input?: SkipOnboardingGithubAppInstallationInput): Promise<SkipOnboardingGithubAppInstallationOutput>;
    ...
    logSources: {
        ...
        verify(input: ContractInputs["logSources"]["verify"]): Promise<ContractOutputs["logSources"]["verify"]>;
    };
    logStreams: {
        ...
        createBatch(input: CreateLogStreamsInput): Promise<CreateLogStreamsOutput>;
        volumeStats(input: GetLogStreamVolumeStatsInput): Promise<GetLogStreamVolumeStatsOutput>;
    };
    connectedAccounts: {
    ...
    integrations: {
        ...
        getActiveCLIAttempt(input: GetActiveCLIAttemptInput): Promise<GetActiveCLIAttemptOutput>;
        getLinearAutomationConfiguration(input: GetLinearAutomationConfigurationInput): Promise<GetLinearAutomationConfigurationOutput>;
        updateLinearAutomationConfiguration(input: UpdateLinearAutomationConfigurationInput): Promise<UpdateLinearAutomationConfigurationOutput>;
        getOrganizationExternalIdentityJitPolicy(input?: ContractInputs["integrations"]["getOrganizationExternalIdentityJitPolicy"]): Promise<ContractOutputs["integrations"]["getOrganizationExternalIdentityJitPolicy"]>;
        updateOrganizationExternalIdentityJitPolicy(input: ContractInputs["integrations"]["updateOrganizationExternalIdentityJitPolicy"]): Promise<ContractOutputs["integrations"]["updateOrganizationExternalIdentityJitPolicy"]>;
        getConnectionExternalIdentityJitPolicy(input: ContractInputs["integrations"]["getConnectionExternalIdentityJitPolicy"]): Promise<ContractOutputs["integrations"]["getConnectionExternalIdentityJitPolicy"]>;
        updateConnectionExternalIdentityJitPolicy(input: ContractInputs["integrations"]["updateConnectionExternalIdentityJitPolicy"]): Promise<ContractOutputs["integrations"]["updateConnectionExternalIdentityJitPolicy"]>;
        getMicrosoftTeamsAdminConsent(input: ContractInputs["integrations"]["getMicrosoftTeamsAdminConsent"]): Promise<ContractOutputs["integrations"]["getMicrosoftTeamsAdminConsent"]>;
        getSlackConfiguration(input: GetSlackConfigurationInput): Promise<GetSlackConfigurationOutput>;
        updateSlackConfiguration(input: UpdateSlackConfigurationInput): Promise<UpdateSlackConfigurationOutput>;
        listSlackChannelProjectMappings(input: ListSlackChannelProjectMappingsInput): Promise<ListSlackChannelProjectMappingsOutput>;
        setSlackChannelProjectMapping(input: SetSlackChannelProjectMappingInput): Promise<SetSlackChannelProjectMappingOutput>;
        deleteSlackChannelProjectMapping(input: DeleteSlackChannelProjectMappingInput): Promise<DeleteSlackChannelProjectMappingOutput>;
    };
    mcpConnectors: {
    ...
    sandboxInitScript: {
        get(input?: Partial<GetSandboxInitScriptInput>): Promise<GetSandboxInitScriptOutput>;
        upsert(input: Omit<UpsertSandboxInitScriptInput, "projectId"> & Partial<Pick<UpsertSandboxInitScriptInput, "projectId">>): Promise<UpsertSandboxInitScriptOutput>;
        delete(input?: Partial<DeleteSandboxInitScriptInput>): Promise<DeleteSandboxInitScriptOutput>;
    };
    sandboxClis: {
        ...
        verify(input: ContractInputs["sandboxClis"]["verify"]): Promise<ContractOutputs["sandboxClis"]["verify"]>;
    };
    signalDefinitions: {
        ...
        delete(input: DeleteSignalDefinitionInput): Promise<DeleteSignalDefinitionOutput>;
    };
    scripts: {
    ...
    issues: {
        ...
        getRejectionContext(input: GetIssueRejectionContextInput): Promise<GetIssueRejectionContextOutput>;
        reject(input: RejectIssueInput): Promise<RejectIssueOutput>;
        ...
        /**
         * Moves a resolved or ignored issue onto a different active component and
         * reopens it in one step.
         */
        reassignAndReopen(input: ReassignAndReopenIssueInput): Promise<ReassignAndReopenIssueOutput>;
    };
    /**
